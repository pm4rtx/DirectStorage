...
#undef ZSTDGPU_RW_TYPED_BUFFER_ALIAS_DECL_GLC
#undef ZSTDGPU_RW_TYPED_BUFFER_ALIAS_DECL
#undef ZSTDGPU_RO_TYPED_BUFFER_ALIAS_DECL

#undef ZSTDGPU_RW_BUFFER_ALIAS_DECL_GLC
#undef ZSTDGPU_RW_BUFFER_ALIAS_DECL
#undef ZSTDGPU_RO_BUFFER_ALIAS_DECL

#undef ZSTDGPU_RW_TYPED_BUFFER_DECL_GLC
